...
namespace DailyEvents.Client.Behaviors
{
    ...
    public class FadeHeaderBehavior : Behavior<FrameworkElement>
    {
        ...
        public static readonly DependencyProperty HeaderElementProperty = 
            DependencyProperty.Register(nameof(HeaderElement), typeof(UIElement), typeof(FadeHeaderBehavior), new PropertyMetadata(null, PropertyChangedCallback));
        ...
        private void AssignFadeAnimation()
        {
            ...
            var opacityExpression = compositor.CreateExpressionAnimation("Clamp(1 - (-ScrollManipulationPropSet.Translation.Y / Height), 0, 1)");
            ...
            opacityExpression.SetScalarParameter("Height", (float)HeaderElement.RenderSize.Height);
